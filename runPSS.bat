...
set "jvmOptions=-Xms256m -Xmx512M -Dorg.optaplanner.examples.dataDir=data/"
rem -Xmx1536m
set "mainClass=org.optaplanner.examples.projectjobscheduling.app.ProjectJobSchedulingApp %1 %2"
set "mainClasspath=bin;d:/optaplanner/optaplanner-distribution-8.12.0.Final/binaries/*;d:/optaplanner/optaplanner-distribution-8.12.0.Final/examples/binaries/*;"

echo Usage: runPSS.bat
echo Notes:
